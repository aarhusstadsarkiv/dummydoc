...
#   parser.add_argument("file", help = "the path to the database generated by Digiarch that dummydoc should search for dummy tiff files", 
#                               type = str)
#   parser.parse_args()
...
#   - Immediately print file somehow instead of storing it in a list? Not sure if that's feasible when it needs to be printed as a tiff file later
